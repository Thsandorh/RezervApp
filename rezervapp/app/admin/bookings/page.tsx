...
export default async function BookingsPage() {
  ...
  // Serialize ALL dates to strings for client component (including nested objects)
  ...
  return (
    <div>
      ...
      <BookingsView bookings={serializedBookings as any} tables={serializedTables} />
    </div>
  )
}
